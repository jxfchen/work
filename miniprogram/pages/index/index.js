...
Page({
  ...
  data: {
    ...
    infolist: [],
    backarr: [],
    imgurlstart: baseUrl.config.image_base_url,
    address: '',
  },
  ...
  onLoad: function (options) {
    ...
    c.request("index/getbanner", {
      ...
      var backarr_str = JSON.stringify(res.info);
      backarr = JSON.parse(backarr_str);
      for (let i = 0; i < res.info.length; i++) {
        var str = "https://www.infinitybuild.cn/" + res.info[i].img;
        background.push(str)
      }
      date.backarr = backarr;
